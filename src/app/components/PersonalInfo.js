            ...
            <div className="personal_info__details">
                <div className="personal_info__header">
                    ...
                    <div>
                        ...
                        <p className="personal_info__job">Systems Engineer | Cloud & DevOps</p>
                    </div>
                </div> 
                <div className="personal_info__body">
                    <div className="personal_info__skills">
                        ...
                        <div className='personal_info__social'>
                            <a className='social_page' href='https://www.linkedin.com/in/luis-hernández-3871aa25a' target='_blank' rel='noopener noreferrer'><FaLinkedin/></a>
